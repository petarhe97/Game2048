 ...
 */
   private void initConfig()
   {
      int picNum;
      try{
         BufferedReader in = new BufferedReader(new FileReader("gui_config.txt"));
         logoIconFile = in.readLine();
         picNum =Integer.parseInt(in.readLine());
         slotIconFile = new String [picNum];
 ...
 */     
   public static void main(String[] args) 
   {
      ...
      try{
         File music1 = new File("bgm.wav");
         File music2 = new File("bgm2.wav");
         while(true){
            playClip(music1);
            playClip(music2);
         }
         ...
         System.out.println("Error finding music.");
      }
   }
}